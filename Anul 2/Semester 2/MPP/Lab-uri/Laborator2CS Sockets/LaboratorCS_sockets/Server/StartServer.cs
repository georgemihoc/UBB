...
namespace swim.server
{
    public class StartServer
    {
        ...
        static void Main(string[] args)
        {
			...
			SerialSwimServer server = new SerialSwimServer("127.0.0.1", 55555, serviceImpl);
            server.Start();
        ...
        //public static SwimServerImpl getService()
        //{
        //    return serviceTest;
        //    //ParticipantDbRepository participantDbRepository = new ParticipantDbRepository();
        //    //ProbaDbRepository probaDbRepository = new ProbaDbRepository();
        ...
        //    //SwimServerImpl serviceImpl = new SwimServerImpl(participantDbRepository, probaDbRepository, inscriereDbRepository, organizatorDbRepository);
        //    //return serviceImpl;
        //}
    }
