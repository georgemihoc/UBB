...
int64_t Colectie::hash(TElem e,int64_t i) const {
...
bool Colectie::isEmpty() const {
    //AC=BC=WC=theta(1)
    return sizeOf==0;
}

int Colectie::nrOccurrences(TElem e) const {
...
bool Colectie::search(TElem e) const {
...
int Colectie::greaterPrime(int x) {
