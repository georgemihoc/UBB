...
class Console(object):
    ...
    def __uiCautaPerson(self, params):
        ...
        nume = "Abc"
        adresa = "1"
        a = self.ctrlPerson.cautaPerson(id,nume,adresa)
        if a:
            print(a)
    ...
    def __uiCautaEvent(self, params):
        ...
        timp = None
        desc = None
        a = self.ctrlEvent.cautaEvent(id, data, timp, desc)
        if a:
            print(a)
    ...
    def __uiRaport(self,params):
        ...
        if nr != -1:
            for i in range(0, int(nr)):
               print(b[i].desc," ",AsignController.nr_participanti_recursiv(self,a,0,b,i))
        else:
            print("Imposibil")
    ...
    def __uiFisier(self,params):
        """
            Functie care citeste valorile din fisier
            input-params
            conditii-
            output-
            postconditii-
        ...
        for line in file:
            ...
            if len(words) == 3:
                self.__uiAddPerson(words)
            elif len(words) == 4:
                self.__uiAddEvent(words)
        file.close()

    def __uiCombSort(self,params):
        if len(params) != 0:
            print("Nr parametrii invalid!")
            return
        #a=self.ctrlPerson.getAllPerson()
        a =[5,4,10,3,2]
        lista = AsignController.CombSort(self,a)
        for i in lista:
            print(i)

    def __uiMergeSort(self,params):
        if len(params) != 0:
            print("Nr parametrii invalid!")
            return
        a = [10,5,23,4,11]
        mergeSort(a,key = a,reverse = False)
        print(a)
    ...
    def run(self):
        print("1.Adaugati persoana in lista \n"
              ...
              "19.Citeste elementele din fisierul date_person.txt \n"
              "20.Comb sort lista de persoane \n"
              "21.Exit "
              "22.Merge Sort")
        comenzi = {"1": self.__uiAddPerson,
                   ...
                   "19": self.__uiFisier,
                   "20": self.__uiCombSort,
                   "22":self.__uiMergeSort}
        while True:
            cmd = input()
            params = cmd.split(" ")
            if cmd == "21":
